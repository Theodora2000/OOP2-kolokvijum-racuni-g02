...
public class Program {
    ...
    public static void main(String args[]){
        ...
        //prvi deo
        Racuni.xmlStream(5000).forEach(System.out::println);
        //drugi deo
        System.out.println("Preko pet: " +prekoPet(4,2020) );
        //treci deo
        razlicitiProizvodi(26,4,2020).stream().forEach(System.out::println);
        //cetvrti deo
        prodatoPuta();
        //peti deo
        izvestaj(1,5,2018);
    ...
    private static void izvestaj(int dan, int mes, int god) {
    ...
    private static void prodatoPuta() {
    ...
    private static List<String> razlicitiProizvodi(int dan, int mesec, int godina) {
    ...
    private static long prekoPet(int mes, int god) {
        return Racuni.racuniStream(5000)
                .filter(r->r.getVreme().getYear() == god)
                .filter(r->r.getVreme().getMonthValue() == mes)
